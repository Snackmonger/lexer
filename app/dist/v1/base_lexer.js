...
const program_counter_1 = __importDefault(require("./program_counter"));
const token_template_1 = __importDefault(require("./token_template"));
/**
...
class Lexer {
    ...
    addRule(tokenType, regexPattern, callback) {
        this.templates.push(new token_template_1.default(tokenType, regexPattern, callback));
    }
    /**
    ...
    tokenize(text, ...filterTypes) {
        this.tokens = [];
        this.programCounter = new program_counter_1.default();
        let best;
        while (this.start < text.length) {
            ...
            if (best == null) {
                throw new errors_1.UnknownSymbolError(text, this.line, this.column);
            }
            this.accept(best);
        }
...
//# sourceMappingURL=base_lexer.js.map